...
GPOWERS_PLATFORM_PLUGIN_DIR_kimi_code="${_gp_user_home}/.kimi-code/skills"  # uses prefix mode, not symlink
...
GPOWERS_PLATFORM_MARKER_kimi_code="${_gp_user_home}/.kimi-code"

GPOWERS_ALL_PLATFORMS="claude_code codex gemini cursor opencode copilot kimi kimi_code"
...
export GPOWERS_ALL_PLATFORMS \
  ...
  GPOWERS_PLATFORM_PLUGIN_DIR_kimi GPOWERS_PLATFORM_PLUGIN_DIR_kimi_code \
  ...
  GPOWERS_PLATFORM_MARKER_kimi GPOWERS_PLATFORM_MARKER_kimi_code
