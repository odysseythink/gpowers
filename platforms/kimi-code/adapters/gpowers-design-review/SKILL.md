---
name: gpowers-design-review
description: "post-implementation visual review (gstack) (gpowers adapter for Kimi Code)"
gpowers-source: roles/skills/design-review/SKILL.md
