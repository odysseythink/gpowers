---
name: gpowers-simplify
description: "Simplify code, configs, and processes. Remove unnecessary complexity. (gpowers adapter for Kimi Code)"
gpowers-source: tools/skills/simplify/SKILL.md
