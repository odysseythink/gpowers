---
name: gpowers-fix-the-roof
description: "Fix infrastructure and tooling debt before it becomes an emergency. (gpowers adapter for Kimi Code)"
gpowers-source: tools/skills/fix-the-roof/SKILL.md
