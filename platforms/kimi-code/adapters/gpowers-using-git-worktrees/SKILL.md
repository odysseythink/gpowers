---
name: gpowers-using-git-worktrees
description: "Use when starting feature work that needs isolation from current workspace or before executing implementation plans - ensures an isolated workspace exists via native tools or git worktree fallback (gpowers adapter for Kimi Code)"
gpowers-source: core/skills/using-git-worktrees/SKILL.md
gpowers-module: core
---
...
<!-- SOURCE: $GPOWERS_HOME/core/skills/using-git-worktrees/SKILL.md -->
