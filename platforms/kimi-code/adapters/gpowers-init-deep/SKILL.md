---
name: gpowers-init-deep
description: "Generate hierarchical AGENTS.md (root + complexity-scored subdirs). Use when the project (gpowers adapter for Kimi Code)"
gpowers-source: tools/skills/init-deep/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/tools/skills/init-deep/SKILL.md -->
