---
name: gpowers-requesting-code-review
description: Use when completing tasks, implementing major features, or before merging to verify work meets requirements (gpowers adapter for Kimi)
gpowers-source: core/skills/requesting-code-review/SKILL.md
gpowers-module: core
---
...
<!-- SOURCE: $GPOWERS_HOME/core/skills/requesting-code-review/SKILL.md -->
...
[Dispatch code reviewer subagent]
  ...
  PLAN_OR_REQUIREMENTS: Task 2 from docs/gpowers/plans/deployment-plan.md
  BASE_SHA: a7981ec
  HEAD_SHA: 3df7661
