...
description: "Unified anti-slop frontend design methodology for premium interface generation. Brief inference, Dial system, multi-framework detection, design system mapping, AI-Tells ban, pre-flight checklist. (gpowers adapter for Kimi)"
