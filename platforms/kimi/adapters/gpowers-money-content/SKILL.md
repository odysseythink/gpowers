---
name: gpowers-money-content
description: stub fixture for gstack business skill money-content (gpowers adapter for Kimi)
gpowers-source: business/skills/money-content/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-content/SKILL.md -->


# money-content

Commercial / strategy skill. Writes to $(gpowers-path data)/money-content/.
