---
name: gpowers-money
description: stub fixture for gstack business skill money (gpowers adapter for Kimi)
gpowers-source: business/skills/money/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money/SKILL.md -->


# money

Commercial / strategy skill. Writes to $(gpowers-path data)/money/.
