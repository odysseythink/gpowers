---
name: gpowers-aidesigner-frontend
description: stub fixture for aidesigner-frontend (gpowers adapter for Kimi)
gpowers-source: tools/skills/aidesigner-frontend/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/tools/skills/aidesigner-frontend/SKILL.md -->
