---
name: gpowers-money-finance
description: stub fixture for gstack business skill money-finance (gpowers adapter for Kimi)
gpowers-source: business/skills/money-finance/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-finance/SKILL.md -->


# money-finance

Commercial / strategy skill. Writes to $(gpowers-path data)/money-finance/.
