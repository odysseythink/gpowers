---
name: gpowers-compounding-filter
description: stub fixture for gstack business skill compounding-filter (gpowers adapter for Kimi)
gpowers-source: business/skills/compounding-filter/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/compounding-filter/SKILL.md -->


# compounding-filter

Commercial / strategy skill. Writes to $(gpowers-path data)/compounding-filter/.
