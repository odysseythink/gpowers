---
name: gpowers-sell-the-outcome
description: stub fixture for gstack business skill sell-the-outcome (gpowers adapter for Kimi)
gpowers-source: business/skills/sell-the-outcome/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/sell-the-outcome/SKILL.md -->


# sell-the-outcome

Commercial / strategy skill. Writes to $(gpowers-path data)/sell-the-outcome/.
