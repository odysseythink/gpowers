---
name: gpowers-money-strategy
description: stub fixture for gstack business skill money-strategy (gpowers adapter for Kimi)
gpowers-source: business/skills/money-strategy/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-strategy/SKILL.md -->


# money-strategy

Commercial / strategy skill. Writes to $(gpowers-path data)/money-strategy/.
