---
name: gpowers-money-outreach
description: stub fixture for gstack business skill money-outreach (gpowers adapter for Kimi)
gpowers-source: business/skills/money-outreach/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-outreach/SKILL.md -->


# money-outreach

Commercial / strategy skill. Writes to $(gpowers-path data)/money-outreach/.
