...
description: Use when executing implementation plans with independent tasks in the current session (gpowers adapter for Kimi)
...
[Read plan file once: docs/gpowers/plans/feature-plan.md]
