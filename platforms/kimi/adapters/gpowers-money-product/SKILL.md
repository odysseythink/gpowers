---
name: gpowers-money-product
description: stub fixture for gstack business skill money-product (gpowers adapter for Kimi)
gpowers-source: business/skills/money-product/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-product/SKILL.md -->


# money-product

Commercial / strategy skill. Writes to $(gpowers-path data)/money-product/.
