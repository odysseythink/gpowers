---
name: gpowers-idea-evaluator
description: stub fixture for gstack business skill idea-evaluator (gpowers adapter for Kimi)
gpowers-source: business/skills/idea-evaluator/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/idea-evaluator/SKILL.md -->


# idea-evaluator

Commercial / strategy skill. Writes to $(gpowers-path data)/idea-evaluator/.
