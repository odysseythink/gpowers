...
description: "Cross-platform verify-then-exit loop with independent Oracle verification — prevents premature \"done\" claims by requiring a fresh subagent to re-run verification and emit VERIFIED before exit (gpowers adapter for Kimi)"
