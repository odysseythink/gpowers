---
name: gpowers-writing-plans
description: Use when you have a spec or requirements for a multi-step task, before touching code (gpowers adapter for Kimi)
gpowers-source: core/skills/writing-plans/SKILL.md
gpowers-module: core
---
...
<!-- SOURCE: $GPOWERS_HOME/core/skills/writing-plans/SKILL.md -->
...
**Save plans to:** `docs/gpowers/plans/YYYY-MM-DD-<feature-name>.md`
...
**"Plan complete and saved to `docs/gpowers/plans/<filename>.md`. Two execution options:**
