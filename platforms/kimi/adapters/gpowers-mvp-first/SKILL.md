---
name: gpowers-mvp-first
description: stub fixture for gstack business skill mvp-first (gpowers adapter for Kimi)
gpowers-source: business/skills/mvp-first/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/mvp-first/SKILL.md -->


# mvp-first

Commercial / strategy skill. Writes to $(gpowers-path data)/mvp-first/.
