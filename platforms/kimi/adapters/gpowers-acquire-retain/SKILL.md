---
name: gpowers-acquire-retain
description: stub fixture for gstack business skill acquire-retain (gpowers adapter for Kimi)
gpowers-source: business/skills/acquire-retain/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/acquire-retain/SKILL.md -->


# acquire-retain

Commercial / strategy skill. Writes to $(gpowers-path data)/acquire-retain/.
