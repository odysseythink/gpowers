---
name: gpowers-jtbd-mapping
description: stub fixture for gstack business skill jtbd-mapping (gpowers adapter for Kimi)
gpowers-source: business/skills/jtbd-mapping/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/jtbd-mapping/SKILL.md -->


# jtbd-mapping

Commercial / strategy skill. Writes to $(gpowers-path data)/jtbd-mapping/.
