---
name: gpowers-money-social
description: stub fixture for gstack business skill money-social (gpowers adapter for Kimi)
gpowers-source: business/skills/money-social/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-social/SKILL.md -->


# money-social

Commercial / strategy skill. Writes to $(gpowers-path data)/money-social/.
