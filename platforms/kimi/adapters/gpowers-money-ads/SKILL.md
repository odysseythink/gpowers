---
name: gpowers-money-ads
description: stub fixture for gstack business skill money-ads (gpowers adapter for Kimi)
gpowers-source: business/skills/money-ads/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-ads/SKILL.md -->


# money-ads

Commercial / strategy skill. Writes to $(gpowers-path data)/money-ads/.
