---
name: gpowers-contrarian-timing
description: stub fixture for gstack business skill contrarian-timing (gpowers adapter for Kimi)
gpowers-source: business/skills/contrarian-timing/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/contrarian-timing/SKILL.md -->


# contrarian-timing

Commercial / strategy skill. Writes to $(gpowers-path data)/contrarian-timing/.
