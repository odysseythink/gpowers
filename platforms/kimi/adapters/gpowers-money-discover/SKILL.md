---
name: gpowers-money-discover
description: stub fixture for gstack business skill money-discover (gpowers adapter for Kimi)
gpowers-source: business/skills/money-discover/SKILL.md
...
<!-- SOURCE: $GPOWERS_HOME/business/skills/money-discover/SKILL.md -->


# money-discover

Commercial / strategy skill. Writes to $(gpowers-path data)/money-discover/.
