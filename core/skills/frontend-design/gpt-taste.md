...
## 1. Python-Driven True Randomization

LLMs are inherently lazy and always pick the first layout option. To prevent this, simulate a Python script execution in your `<design_plan>` before writing any UI code.
