...
> **Note:** Stitch is a Google Labs product (labs.google.com/stitch). The DESIGN.md format described here is stable even if Stitch evolves.
...
## 3. Analysis & Synthesis Instructions

### 3.1 Define the Atmosphere
...
### 3.3 Establish Typography Rules
...
### 3.5 Describe Component Stylings
...
### 3.9 List Anti-Patterns (AI Tells)

Encode these as explicit "NEVER DO" rules in the DESIGN.md:

- No emojis anywhere
- No `Inter` font
- No generic serif fonts — distinctive modern serifs only if needed
...
## 4. Output Format (DESIGN.md Structure)
